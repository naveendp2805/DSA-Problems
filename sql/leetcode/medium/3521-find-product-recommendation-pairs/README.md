...
- Product pair (101, 102): Purchased by users 1, 2, and 4 (3 customers) Product 101 is in Electronics category Product 102 is in Books category
- Product pair (101, 103): Purchased by users 1, 3, and 4 (3 customers) Product 101 is in Electronics category Product 103 is in Clothing category
- Product pair (102, 104): Purchased by users 2, 4, and 5 (3 customers) Product 102 is in Books category Product 104 is in Kitchen category
...
**Language:** SQL  
**Runtime:** 566 ms (beats 97.10%)  
**Memory:** 0B (beats 100.00%)  
**Submitted:** 2026-09-16T15:04:49.284Z  
...
[View on LeetCode](https://leetcode.com/problems/find-product-recommendation-pairs/)